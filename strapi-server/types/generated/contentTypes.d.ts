...
export interface ApiAdvertisingBannerAdvertisingBanner
  ...
  info: {
    description: '';
    displayName: 'advertising_banner';
  ...
  attributes: {
    available_offer: Schema.Attribute.Component<'banner.offer', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    button: Schema.Attribute.Component<'banner.button', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    button: Schema.Attribute.Component<'banner.button', true>;
    content: Schema.Attribute.Text;
    cover_images: Schema.Attribute.Media<'images' | 'videos', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author_detail: Schema.Attribute.Component<'testimonial.profile', false>;
    blog_overview: Schema.Attribute.Text;
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Collection for storing contact information';
    displayName: 'Contact';
    pluralName: 'contacts';
...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'footer.info', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    advertising_banner: Schema.Attribute.Relation<
      'oneToOne',
      'api::advertising-banner.advertising-banner'
    >;
    ...
    >;
    other_sections: Schema.Attribute.DynamicZone<
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    price_currancy: Schema.Attribute.String;
    product_images: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    product_status: Schema.Attribute.Enumeration<['In Stock', 'Out of Stock']>;
    publishedAt: Schema.Attribute.DateTime;
