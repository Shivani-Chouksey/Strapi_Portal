"use client";
import { All_Categories_BaseUrl, All_Product_BaseUrl } from "@/apiEndpoints";
...
function Page() {
  ...
  const getAllCategoresData = async () => {
    try {
      const responseData = await axios.get(
        `${All_Categories_BaseUrl}&filters[slug][$in]=${name}`
      );
